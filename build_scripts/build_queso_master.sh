...
(./bootstrap; ./configure --with-hdf5=$HDF5_DIR --without-trilinos --prefix=$QUESO_DIR --enable-debug=yes CXXFLAGS="-g -O0 -Wall" 2>&1 && touch build_cmd_success) | tee configure.log
